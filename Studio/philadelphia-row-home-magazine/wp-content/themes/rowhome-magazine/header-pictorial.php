<?php
/**
 * Pictorial header — Direction B
 * Loaded by single-pictorial.php via get_header('pictorial').
 * Full-bleed layout: no container wrapper on <main> — each section controls its own width.
 *
...
<body <?php body_class('rh-direction-b rh-pictorial-page'); ?>>
<?php wp_body_open(); ?>
...
<main id="main" class="rh-pictorial-main">
