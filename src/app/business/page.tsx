...
export default function BusinessPage() {
  const category = categories.find(c => c.slug === 'business')
        ...
        <section className="py-12 bg-background-light">
          <div className="container-magazine">
            <nav className="flex items-center space-x-2 text-sm text-text-muted mb-6">
              ...
              <span>/</span>
              <span className="text-text-dark">Business</span>
            </nav>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-text-light leading-relaxed">
                Stay informed about Philadelphia's business landscape, from startups to established enterprises.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-background-teal text-white">
          <div className="container-magazine text-center">
            <h2 className="text-3xl font-serif font-bold mb-4">
              Stay Updated on Business
            </h2>
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Get notified when we publish new business articles and other Philadelphia stories you'll love.
            </p>
