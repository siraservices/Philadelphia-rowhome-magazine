...
export default function HealthPage() {
  const category = categories.find(c => c.slug === 'health')
  const articles = getArticlesByCategory('health')
        ...
        <section className="py-12 bg-background-light">
          <div className="container-magazine">
            <nav className="flex items-center space-x-2 text-sm text-text-muted mb-6">
              ...
              <span>/</span>
              <span className="text-text-dark">Health</span>
            </nav>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-text-light leading-relaxed">
                Explore wellness, fitness, and health topics for living your best life in Philadelphia.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-background-teal text-white">
          <div className="container-magazine text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Get notified when we publish new health articles and other Philadelphia stories you'll love.
            </p>
